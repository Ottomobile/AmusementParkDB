...
<head>
    ...
    <title>Project Select Query Result</title>
</head>
<body style="background-image:url('../images/AmusementPark-3.jpg'); background-size:100%; background-repeat:repeat-y">
    ...
    <div class="row">
        <div class="col-md-6 col-md-offset-3">
            <h1 id="header-1">Project Select Query Result</h1>
        </div>
    </div>
    <div class="row">
        <div class="col-md-6 col-md-offset-3">
            <form role="form" id="form-background">
                <p id="p-label">Project Select Query Result</p>
                <table class="table table-striped" style="background-color:white">
                    ...
                    <tbody>
                        <?php
                            ...
                            // Formulate query
                            $query = sprintf("SELECT name FROM guest WHERE YEAR(birthDate) >= '%s'", $year);
