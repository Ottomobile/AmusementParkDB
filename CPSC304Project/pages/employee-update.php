<?php
    ...
    elseif($name && $gender && $birthdate && $phoneNumber && $address && $password){

        // Prepare update statement
        $query = sprintf("UPDATE employee
                          SET gender='%s', birthDate='%s', phoneNumber='%s', address='%s', loginPwd='%s'
                          WHERE name='%s';",
                          $gender, $birthdate, $phoneNumber, $address, $password, $name);
...
<body style="background-image:url('../images/AmusementPark-1.jpg'); height:100%">
        ...
        <div class="container-fluid">
            ...
            <div class="collapse navbar-collapse" id="myNavbar">
                <ul class="nav navbar-nav">
                    ...
                    <li>
                        <a href="employee-account.php">Employee</a>
                    </li>
                </ul>
    ...
    <div class="row">
        <div class="col-md-6 col-md-offset-3">
            <h1 id="header-1">Employee Account Update Status</h1>
        </div>
    </div>
    <div class="row">
        <div class="col-md-6 col-md-offset-3">
            <form role="form" id="form-background">
                ...
                ?>
                <br>
                <a class="btn btn-default" href="employee-account.php">Employee Account Home</a>
            </form>
        </div>
    </div>
