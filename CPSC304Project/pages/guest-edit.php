...
<body style="background-image:url('../images/AmusementPark-1.jpg'); height:100%">
    ...
    <div class="row">
        <div class="col-md-6 col-md-offset-3">
            <h1 id="header-1">Edit Guest Details</h1>
        </div>
    </div>
    <div class="row">
        <div class="col-md-6 col-md-offset-3">
            <form role="form" action="guest-update.php" id="form-background" method="post">
                ...
                <div class="form-group">
                    ...
                    <input name="email" type="email" class="form-control" id="email" placeholder="John.Smith@ubc.ca" value="<?php echo $row['emailAddress']; ?>" required />
                </div>
                <div class="form-group">
                ...
                <a href="guest-account.php" class="btn btn-default">Cancel</a>
            </form>
        </div>
    </div>
